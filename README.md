...
- **🟢 Зеленый текст времени** - быстрый ответ (< 1s)
- **🟡 Желтый текст времени** - среднее время (1-3s)
- **🔴 Красный текст времени** - медленный ответ (> 3s)
...
- **Performance**: комплексный скор на основе рейтингов и бенчмарков (компактное отображение времени)
...
**Компоненты оценки:**
- **⏰ Скорость**: время ответа с цветовой индикацией
- **⚡ Качество**: процент успешных тестов (зеленый)
- **⭐ Рейтинг**: пользовательские оценки (желтый)
